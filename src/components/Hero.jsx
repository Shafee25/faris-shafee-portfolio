        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="text-base md:text-lg text-gray-400 mb-8 max-w-xl mx-auto lg:mx-0 leading-relaxed">
              ...
              . A Full-Stack Engineer specialized in React, Angular, Tailwind
              CSS, Node, Next Js, Express JS, Mongo DB, MS SQL, My SQL, Oracle
              DB, Stored Procedures, Azure & AWS. I transform complex problems
              into secure, high-performance applications.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 mb-12">
              <a
                href="#projects"
                className="w-full sm:w-auto px-8 py-3.5 bg-highlight text-primary font-bold rounded-full hover:bg-white hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2 shadow-lg shadow-highlight/20"
              >
          ...
          >
            <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-[400px] lg:h-[400px]">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="absolute bottom-6 -left-4 md:-left-8 z-20 bg-[#0A1619] p-3 md:p-4 rounded-xl shadow-xl border border-gray-800 flex items-center gap-3 hover:-translate-y-1 transition-transform cursor-pointer group"
              >
                <Linkedin
                  size={20}
                  className="text-blue-500 group-hover:text-white transition-colors"
                />
                <span className="hidden md:block font-bold text-white text-sm">
                  LinkedIn
                </span>
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="absolute top-10 -right-4 md:-right-8 z-20 bg-[#0A1619] p-3 md:p-4 rounded-xl shadow-xl border border-gray-800 flex items-center gap-3 hover:-translate-y-1 transition-transform cursor-pointer group"
              >
                <Github
                  size={20}
